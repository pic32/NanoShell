...
#include "../NanoShell.h"
	...
	SHELL_TAB SHELL_TAB"-P        requests that the system be powered off after it has been brough down" SHELL_DEFAULT_END_OF_LINE_SEQUENCE \
	...
	#define SHUTDOWN_HELP_TEXT \
	\
	SHUTDOWN_COMMAND_NAME ": " SHUTDOWN_COMMAND_NAME SHELL_DEFAULT_END_OF_LINE_SEQUENCE \
	SHELL_DEFAULT_END_OF_LINE_SEQUENCE \
	SHELL_TAB "Arranges for the system to be brought down in a safe way." SHELL_DEFAULT_END_OF_LINE_SEQUENCE \
	SHELL_DEFAULT_END_OF_LINE_SEQUENCE \
